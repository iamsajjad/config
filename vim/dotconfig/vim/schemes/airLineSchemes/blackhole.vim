...
" Normal mode
let s:N1   = [ s:gui0D, s:guiTS, s:cterm0D, s:ctermTS ]
let s:N2   = [ s:gui0F, s:guiTS, s:cterm0F, s:ctermTS ]
let s:N3   = [ s:gui0B, s:guiTS, s:cterm0B, s:ctermTS ]
let g:airline#themes#blackhole#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Insert mode
let s:I1   = [ s:gui0C, s:guiTS, s:cterm0C, s:ctermTS ]
let s:I2   = [ s:gui0F, s:guiTS, s:cterm0F, s:ctermTS ]
let s:I3   = [ s:gui0B, s:guiTS, s:cterm0B, s:ctermTS ]
...
let s:R2   = [ s:gui0F, s:guiTS, s:cterm0F, s:ctermTS ]
let s:R3   = [ s:gui0B, s:guiTS, s:cterm0B, s:ctermTS ]
let g:airline#themes#blackhole#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)

" Visual mode
let s:V1   = [ s:gui0A, s:guiTS, s:cterm0A, s:ctermTS ]
let s:V2   = [ s:gui0F, s:guiTS, s:cterm0F, s:ctermTS ]
let s:V3   = [ s:gui0B, s:guiTS, s:cterm0B, s:ctermTS ]
...
let s:CP1 = [ s:gui0D, s:guiTS, s:cterm0D, s:ctermTS ]
let s:CP2 = [ s:gui0F, s:guiTS, s:cterm0F, s:ctermTS ]
let s:CP3 = [ s:gui0B, s:guiTS, s:cterm0B, s:ctermTS ]
