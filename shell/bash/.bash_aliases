...
alias la='ls -Alh --group-directories-first --color=always' # show hidden files
alias ls='ls -aFh --group-directories-first --color=always' # add colors and file type extensions
